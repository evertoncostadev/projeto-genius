...
            showCustomAlert('Erro de Validação', 'Telefone inválido. Deve conter 10 ou 11 números (DDD + Número).', 'error'); return;
        }
        
        const hoje = new Date();
...
                    
                    if (data.erro) {
                        showAlert('Erro no CEP', 'CEP não encontrado. Verifique o número.', 'error');
                        return;
                    }
...
                    showAlert('Erro no CEP', 'Não foi possível buscar o CEP. Tente novamente.', 'error');
                }
            }
        });
    }
