...
class Emprestimo {
    ...
    static async encerrar(id, observacoesDevolucao) {
        const query = `
            ...
            SET status = 'encerrado', 
                data_devolucao_real = (CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo'), 
    ...
    static async getAtividadeSemana() {
        const query = `
            ...
            FROM emprestimos
            WHERE data_emprestimo >= ((CURRENT_TIMESTAMP AT TIME ZONE 'America/Sao_Paulo')::DATE - INTERVAL '7 days')
