...
// =============================================
// ⚡️ CORREÇÃO ESSENCIAL: ROTA RAIZ (/) PARA CARREGAR O LOGIN
// =============================================
app.get('/', (req, res) => {
    // Isso garante que, ao acessar a raiz do servidor, 
    // o arquivo login.html seja servido, corrigindo o "Cannot GET /"
    res.sendFile(path.join(__dirname, '../frontend', 'login', 'login.html'));
});

// =============================================
// --- ROTAS DA API DE USUÁRIOS (PROTEGIDAS) ---
// =============================================
...
// REMOVIDA AQUI, AGORA ESTÁ NA ÁREA PÚBLICA ABAIXO
...
// =============================================
// --- ROTAS DA API DE NOTEBOOKS (PROTEGIDAS) ---
// =============================================
...
// =============================================
// --- ROTAS DA API DE EMPRÉSTIMOS (PROTEGIDAS) ---
// =============================================
...
// =============================================
// --- ROTAS DE ESTATÍSTICAS E LOGIN (PÚBLICAS) ---
// =============================================
...
// >>> ROTA DE CADASTRO DE USUÁRIO (AGORA PÚBLICA) <<<
